...
if __name__ == "__main__":
    ...
    # for x,y in canvas_corners1:
    #     output1 = cv2.circle(output1, (x,y), 10, (0,0,255), 10) 
    # for x,y in canvas_corners2:
    #     output1 = cv2.circle(output1, (x,y), 10, (0,0,255), 10) 
    # for x,y in canvas_corners3:
    #     output1 = cv2.circle(output1, (x,y), 10, (0,0,255), 10) 
    # for x,y in canvas_corners4:
    #     output1 = cv2.circle(output1, (x,y), 10, (0,0,255), 10) 
    # for x,y in canvas_corners5:
    #     output1 = cv2.circle(output1, (x,y), 10, (0,0,255), 10) 
